...
set_property PACKAGE_PIN T8 [get_ports {button_assert}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {button_assert}]
#Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LED1
#set_property PACKAGE_PIN V9 [get_ports {change_2}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {change_2}]
#Bank = 34, Pin name = IO_L24P_T3_34,						Sch name = LED2
#set_property PACKAGE_PIN R8 [get_ports {change_1}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {change_1}]
#Bank = 34, Pin name = IO_L23N_T3_34,						Sch name = LED3
#set_property PACKAGE_PIN T6 [get_ports {vend}]					
